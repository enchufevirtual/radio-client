...
import { SvgStyle, LogoWrapper, BackgroundLayer } from './styles';

type RadioLogoProps = {
  onClick?: () => void;
}

export const RadioLogo = ({ onClick }: RadioLogoProps) => {
  ...
  return (
    <LogoWrapper onClick={onClick} active={active}>
      <BackgroundLayer active={active} />
      <SvgStyle
